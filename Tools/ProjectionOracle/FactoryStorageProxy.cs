...
/// <summary>Only supplies the three storage lookups ProjectionFactory uses for flat definitions.</summary>
public class FactoryStorageProxy : DispatchProxy
{
    Func<MethodInfo, object?> _dispatch = null!;

    /// <summary>Creates a strict, in-memory event-sequence lookup for the production projection factory.</summary>
